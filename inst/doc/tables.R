...
###################################################
### code chunk number 1: tables.Rnw:25-26
###################################################
options(width=60)


###################################################
### code chunk number 2: tables.Rnw:49-51
###################################################
library(tables)
...
###################################################
### code chunk number 4: tables.Rnw:61-64
###################################################
toLatex(
tabular( (Species + 1) ~ (n=1) + Format(digits=2)*
         (Sepal.Length + Sepal.Width)*(mean + sd), data=iris )
...
###################################################
### code chunk number 5: tables.Rnw:71-72 (eval = FALSE)
###################################################
## booktabs()


###################################################
### code chunk number 6: tables.Rnw:76-78
###################################################
...
###################################################
### code chunk number 8: tables.Rnw:146-153
###################################################
set.seed(100)
X <- rnorm(10)
X
...
###################################################
### code chunk number 9: tables.Rnw:293-294
###################################################
saved.options


###################################################
### code chunk number 10: tables.Rnw:301-302
###################################################
table_options()[c("toprule", "midrule", "bottomrule", "titlerule")]


###################################################
### code chunk number 11: tables.Rnw:306-307 (eval = FALSE)
###################################################
## toLatex(
## tabular( (Species + 1) ~ (n=1) + Format(digits=2)*
##          (Sepal.Length + Sepal.Width)*(mean + sd), data=iris )
...
###################################################
### code chunk number 12: tables.Rnw:310-311
###################################################
toLatex(
tabular( (Species + 1) ~ (n=1) + Format(digits=2)*
         (Sepal.Length + Sepal.Width)*(mean + sd), data=iris )
...
###################################################
### code chunk number 14: tables.Rnw:329-330
###################################################
toLatex(tabular(Species ~ (n=1) + Format(digits=2)*
         (Sepal.Length + Sepal.Width)*(mean + sd), data=iris),
      options=list(doFooter=FALSE, doEnd=FALSE))
...
###################################################
### code chunk number 15: tables.Rnw:383-384
###################################################
toLatex( tabular(F + 1 ~ 1) )


###################################################
### code chunk number 16: tables.Rnw:399-400
###################################################
toLatex( tabular( X*F*(mean + sd) ~ 1 ) )


###################################################
### code chunk number 17: tables.Rnw:412-413
###################################################
toLatex( tabular( X*F ~ mean + sd ) )


###################################################
### code chunk number 18: tables.Rnw:427-428
###################################################
toLatex( tabular( X*(Newname=F) ~ mean + sd ) )


###################################################
### code chunk number 19: tables.Rnw:451-452
###################################################
toLatex( tabular( (F+1) ~ (n=1) + X*(mean + sd) ) )


###################################################
### code chunk number 20: tables.Rnw:464-467
###################################################
...
###################################################
### code chunk number 21: tables.Rnw:477-479
###################################################
...
###################################################
### code chunk number 22: tables.Rnw:509-511
###################################################
...
###################################################
### code chunk number 23: tables.Rnw:546-548
###################################################
...
###################################################
### code chunk number 24: tables.Rnw:559-568
###################################################
...
###################################################
### code chunk number 25: tables.Rnw:582-584
###################################################
...
###################################################
### code chunk number 26: tables.Rnw:616-618
###################################################
...
###################################################
### code chunk number 27: tables.Rnw:625-627
###################################################
...
###################################################
### code chunk number 28: tables.Rnw:641-643
###################################################
...
###################################################
### code chunk number 29: tables.Rnw:683-689 (eval = FALSE)
###################################################
...
###################################################
### code chunk number 30: tables.Rnw:690-696
###################################################
toLatex( tabular( (Factor(gear, "Gears") + 1)
          *((n=1) + Percent() 
...
###################################################
### code chunk number 31: tables.Rnw:720-726
###################################################
...
###################################################
### code chunk number 32: tables.Rnw:730-732 (eval = FALSE)
###################################################
## toLatex( tabular( (Factor(gp) + 1) 
...
###################################################
### code chunk number 33: tables.Rnw:757-764
###################################################
set.seed(730)
...
###################################################
### code chunk number 34: tables.Rnw:769-772
###################################################
toLatex( tabular( Label ~ Group*Value*mean*
			DropEmpty(empty="."), 
		data = df[1:6,]))
...
###################################################
### code chunk number 35: tables.Rnw:815-816
###################################################
toLatex( tabular( Species ~ Heading()*mean*All(iris), data=iris) )


###################################################
### code chunk number 36: tables.Rnw:829-832
###################################################
df <- mtcars[1:10,]
...
###################################################
### code chunk number 37: tables.Rnw:847-851
###################################################
...
###################################################
### code chunk number 38: tables.Rnw:860-865
###################################################
...
###################################################
### code chunk number 39: tables.Rnw:890-892
###################################################
...
###################################################
### code chunk number 40: tables.Rnw:931-934
###################################################
stderr <- function(x) sd(x)/sqrt(length(x))
...
###################################################
### code chunk number 41: tables.Rnw:966-973
###################################################
...
###################################################
### code chunk number 42: tables.Rnw:1017-1020
###################################################
subset <- 1:15
...
###################################################
### code chunk number 43: tables.Rnw:1027-1036
###################################################
set.seed(1000)
...
###################################################
### code chunk number 44: tables.Rnw:1058-1066
###################################################
subset <- 1:50
toLatex( tabular( RowFactor(subset, "$i$", spacing=5, 
                                             suppressfirst=FALSE)  ~ 
...
###################################################
### code chunk number 45: tables.Rnw:1075-1079
###################################################
subset <- 1:10
...
###################################################
### code chunk number 46: tables.Rnw:1094-1097 (eval = FALSE)
###################################################
...
###################################################
### code chunk number 47: tables.Rnw:1103-1106
###################################################
...
###################################################
### code chunk number 48: tables.Rnw:1153-1156
###################################################
...
###################################################
### code chunk number 49: tables.Rnw:1159-1160 (eval = FALSE)
###################################################
## toLatex( tabular( mean ~ A*B_label, data=df ) ) 


###################################################
### code chunk number 50: tables.Rnw:1165-1167
###################################################
...
###################################################
### code chunk number 51: tables.Rnw:1187-1190
###################################################
...
###################################################
### code chunk number 52: tables.Rnw:1198-1200
###################################################
...
###################################################
### code chunk number 53: tables.Rnw:1206-1207
###################################################
toLatex( tabular( mean ~ a + b, data = na.omit(dat) ) )


###################################################
### code chunk number 54: tables.Rnw:1213-1216
###################################################
toLatex( tabular( 
...
###################################################
### code chunk number 55: tables.Rnw:1226-1230
###################################################
A <- factor(dat$a)
...
###################################################
### code chunk number 56: tables.Rnw:1240-1249
###################################################
set.seed(1206)
...
###################################################
### code chunk number 57: tables.Rnw:1255-1256
###################################################
toLatex(tab[ tab[,1] > 0, ])


###################################################
### code chunk number 58: tables.Rnw:1263-1270
###################################################
...
###################################################
### code chunk number 59: tables.Rnw:1276-1280
###################################################
colLabels(tab)
labs <- colLabels(tab)
labs[1, 2] <- "New label"
...
###################################################
### code chunk number 60: tables.Rnw:1283-1284
###################################################
toLatex(tab)


###################################################
### code chunk number 61: tables.Rnw:1316-1321 (eval = FALSE)
###################################################
## library(magrittr)
## library(kableExtra)
## toKable(tab) %>% 
...
###################################################
### code chunk number 62: tables.Rnw:1340-1344
###################################################
